  ...
  <div class="add-model-div" :class="addmodelwidth">
    ...
    <el-card class="add-model-el-card">
      <div class="edit-data" ref="addModelDiv" v-show="!addResult && !customFieldsVisible">
          ...
          <el-row class="row">
            ...
            <el-col :span="12">
              <el-form-item class="data-des" label="逻辑模型描述：" prop="description">
                <el-input type="textarea" :rows="3" placeholder="请输入" class="database-textarea" v-model="editModel.description" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row class="row">
        ...
        <setFieldMapping ref="setFieldMapping1" v-show="active === 2" :selected-model="editModel" :soruce-tables="soruceTables" />
      </div>
      <div ref="footerDiv" class="add-model-footer">
        <span slot="footer" class="dialog-footer">
          ...
          <el-button v-show="active === 2" class="next-btn" @click="createModel" :loading="modelLoading">确 定</el-button>
      ...
      />
      <addCustomFields ref="addCustomFields1" v-if="customFieldsVisible" :model="editModel" @dialog-callback="addCustomFieldsCallback" />
    </el-card>
  </div>
</template>
